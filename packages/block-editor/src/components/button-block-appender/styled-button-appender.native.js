...
function StyledButtonAppender( { onClick, isOpen, disabled, style, getStylesFromColorScheme } ) {
	const appenderStyle = {
		...styles.appender,
	...
	return (
		<Button onClick={ onClick } aria-expanded={ isOpen } disabled={ disabled } fixedRatio={ false }>
